        ...
        <div className="side1">
          ...
          <div className="padd cat-flex">
            <ul>
              ...
              <li>&#10094; &nbsp;Electronics</li>
              <li>
                <span className="arw">&#10095;</span> &nbsp;Storage 
              </li>
              <li>
                <span className="arw">&#10095;</span> &nbsp;Displays
              </li>
            </ul>
          </div>
          <hr />
                ...
                <>
                  ...
                  >
                    ...
                    <div className="product-flex">
                      ...
                      <label className="product-price">&#8377;{Math.ceil(element.price * 79.89)}</label>
                    </div>
                  </div>
                </>
              );
